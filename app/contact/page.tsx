  ...
  return (
    <main className="flex flex-col items-center text-lg lg:text-xl font-medium text-white gap-20 my-8">
      ...
      <div className='flex flex-col gap-6 w-full items-center'>
          ...
          text={"Email"}
          className={"bg-red-500/80 backdrop-blur"} icon={'/gmail.svg'}          />
        <ButtonLink
          href={"https://www.instagram.com/ismirk8"}
          text={"Instagram"}
          className={"bg-gradient-to-r from-[#feda75]/60 via-[#d62976]/60 to-[#4f5bd5]/60 backdrop-blur"} icon={'/instagram.svg'}        />
        <ButtonLink
