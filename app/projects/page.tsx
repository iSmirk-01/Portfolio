...
function Projects() {
  return (
    <main className="flex flex-col items-center justify-center gap-48 my-10">
      <h1 className="text-6xl tracking-wide mt-10 font-bold">Projects</h1>
      <div className="space-y-44 w-full">
        <Card
          title={"Landing Page"}
          description={
